package com.iago.servi_track.exceptions.handlers;

import com.iago.servi_track.exceptions.ApiException;
import com.iago.servi_track.exceptions.UnauthorizedException;
import com.iago.servi_track.exceptions.responses.StandardError;
...
public class GlobalExceptionHandler {
    ...
    public StandardError handle(RuntimeException ex) {
        log(ex, 10);
        return new StandardError("An internal error has occurred");
    }
